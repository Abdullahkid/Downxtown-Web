...
export function StoreProductGrid({
  ...
  // Infinite scroll:
  //  - When SSR products exist and no filter is active → start from page 2
  //  - When filter is active or no SSR products → start from page 1
  ...
  // Merge SSR page 1 + client pages 2+
